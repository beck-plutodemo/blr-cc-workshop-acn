# CLAUDE.md — BLR Claude Code Workshop (Accenture)

This file provides context and guidance for Claude Code when working within this repository.

## Repository Purpose

This repo is the student workshop package for the Bengaluru Claude Code Workshop (Accenture cohort). It contains workshop materials, guides, slides, code snippets, and the hackathon brief and submissions.
